...
public class LoginTestWithDataPrivader extends ReadProperties {

	private WebDriver driver;
	private static final Logger logger = 
			LogManager.getLogger(LoginTestWithDataPrivader.class); 
	
	private DemoGuruPage page;
